        ...
        <template v-slot:prepend>
            <v-menu>
                <template v-slot:activator="{ props }">
                    <v-btn icon="$vuetify" v-bind="props">
                ...
                <v-list>
                    <v-list-item v-for="(item, index) in navigation" :key="index" :value="index">
                        <v-list-item-title @click="item.onclick">{{ item.title }}</v-list-item-title>
                    </v-list-item>
                </v-list>
            </v-menu>
        </template>
        <v-app-bar-title>{{ curent }}</v-app-bar-title>
    </v-app-bar>
</template>
...
export default {
    ...
    methods: {
        createCharacter() {
            this.$inertia.visit(route('characters.create'));
        },
        allCharacters() {
